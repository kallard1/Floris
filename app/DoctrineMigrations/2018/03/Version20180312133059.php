 ...
 */
class Version20180312133059 extends AbstractMigration
{
    public function up(Schema $schema)
    {
        ...
        $this->addSql('CREATE TABLE cart (id INT NOT NULL, customer_id INT DEFAULT NULL, cart TEXT DEFAULT NULL, PRIMARY KEY(id))');
