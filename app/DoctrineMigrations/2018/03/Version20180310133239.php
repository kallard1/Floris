 ...
 */
class Version20180310133239 extends AbstractMigration
{
    public function up(Schema $schema)
    {
        ...
        $this->addSql('DROP SEQUENCE ext_translations_id_seq1 CASCADE');
        $this->addSql('DROP SEQUENCE ext_translations_id_seq2 CASCADE');
    ...
    public function down(Schema $schema)
    {
        ...
        $this->addSql('CREATE SEQUENCE ext_translations_id_seq1 INCREMENT BY 1 MINVALUE 1 START 1');
        $this->addSql('CREATE SEQUENCE ext_translations_id_seq2 INCREMENT BY 1 MINVALUE 1 START 1');
